...
st.markdown("""
    ...
    .kpi-box h5 { color: #666666 !important; margin-bottom: 5px; }
    .kpi-box h2 { color: #4E148C !important; font-weight: 800; margin: 0; }
...
st.markdown("""
    <div class="main-header">
        ...
        <h2 style="text-align: center; color: #FFD700; margin:10px 0 0 0; font-family: 'Segoe UI', sans-serif; font-weight: 700;">PLATEFORME EXPERTE DE PREDICTION & COMPUTING BIG DATA</h2>
        <div style="text-align: center; margin-top: 15px; color: #e1e1e1; font-size: 1.1rem;">
            <span>Module : <b>Data Science & Machine Learning</b></span> | <span>Encadré par : <b style="color: #FFD700;">Monsieur Aaroud</b></span>
        </div>
    </div>
""", unsafe_allow_html=True)
